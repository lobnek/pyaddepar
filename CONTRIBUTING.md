# Contributing to pyaddepar

This document is a guide to contributing to pyaddepar
...
## Building pyaddepar from source

You'll need to build pyaddepar locally in order to start editing code.
To install pyaddepar from source, clone the Github
...
To contribute to pyaddepar, send us pull requests.
For those new to contributing, check out Github's
[guide](https://help.github.com/articles/using-pull-requests/).

Once you've made your pull request, a member of the pyaddepar
...
If you'd like to add a new feature to pyaddepar, please do propose your
...
- Read the pyaddepar source and enhance the documentation,
  or address TODOs
- Browse the [issue tracker](https://github.com/lobnek/pyaddepar/issues),
...
pyaddepar tests live in the directory `tests`,
